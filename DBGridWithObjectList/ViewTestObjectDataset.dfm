object frmObjectDataSetTest: TfrmObjectDataSetTest
  ...
  object dbgList: TDBGrid
    ...
    TitleFont.Style = []
    OnColEnter = dbgListColEnter
    OnColExit = dbgListColExit
    OnEditButtonClick = dbgListEditButtonClick
    OnEnter = dbgListEnter
    OnExit = dbgListExit
    ...
    Columns = <
      ...
      item
        ...
        Title.Caption = #218'ltima Edi'#231#227'o'
        Visible = True
      end
      item
        Expanded = False
